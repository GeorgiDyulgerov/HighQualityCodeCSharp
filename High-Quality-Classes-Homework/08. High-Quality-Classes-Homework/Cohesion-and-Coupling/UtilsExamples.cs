namespace CohesionAndCoupling
{
    ...
    class UtilsExamples
    {
        static void Main()
        {
            Console.WriteLine(FileComands.GetFileExtension("example"));
            Console.WriteLine(FileComands.GetFileExtension("example.pdf"));
            Console.WriteLine(FileComands.GetFileExtension("example.new.pdf"));

            Console.WriteLine(FileComands.GetFileNameWithoutExtension("example"));
            Console.WriteLine(FileComands.GetFileNameWithoutExtension("example.pdf"));
            Console.WriteLine(FileComands.GetFileNameWithoutExtension("example.new.pdf"));
